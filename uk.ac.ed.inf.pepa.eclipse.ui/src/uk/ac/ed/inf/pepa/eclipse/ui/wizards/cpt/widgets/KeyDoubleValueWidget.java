...
public class KeyDoubleValueWidget extends CapacityPlanningWidget {
	
	private String key, value1, value2;
	private Control control;
	private final Text text1, text2;

	public KeyDoubleValueWidget(final IValidationCallback cb, 
	...
	public boolean isValid() {
		...
		return control.setValue(this.key, Config.LABMIN, text1.getText()) && 
