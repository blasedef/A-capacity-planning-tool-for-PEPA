...
public class AverageResponseTimeContainer extends PerformanceMetricContainer {
	...
	public AverageResponseTimeContainer(IValidationCallback cb,	Composite container, ODEConfig configODE, PEPAConfig configPEPA) {
	...
	public boolean validConfiguration() {
		...
		boolean isOkEnabled = super.validConfiguration()
