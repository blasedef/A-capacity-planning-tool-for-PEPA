...
public class ParticleSwarmOptimisationLabCandidate extends LabCandidate {
	
	public ParticleSwarmOptimisationLabCandidate(int i,
	...
	public Candidate copySelf() {
		Candidate temp = (Candidate) new ParticleSwarmOptimisationLabCandidate(this.generation,
				labParameters,
