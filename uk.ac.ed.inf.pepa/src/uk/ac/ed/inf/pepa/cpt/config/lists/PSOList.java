...
public class PSOList extends RangeList {
	...
	public void defaultUnits(){
		...
		this.myHashMap.put(Config.LABGEN,new MetaheuristicSearchParameters(1.0,10.0,1.0));
		this.myHashMap.put(Config.LABPOP,new MetaheuristicSearchParameters(1.0,10.0,1.0));
